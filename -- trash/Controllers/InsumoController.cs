...
class insumo_controller {
    ...
    public function listar() {
        ...
        require_once '../views/insumo/listar_insumo.php';
    }
    public function listarTodo() {
        ...
        $totalPages = ceil($total/$limit);
        require_once '../views/insumo/habilitar_insumo.php';
    }
    public function cargarRegistrar() {
        require_once '../views/insumo/registrar_insumo.php';
    }
    public function cargarActualizar() {
        if(isset($_GET['id'])) {
            $item = $this->modelo->buscarPorId($_GET['id']);
            require_once '../views/insumo/actualizar_insumo.php';
        } else {
            header('Location: index.php?controller=insumo&action=listar'); exit;
        }
    }
    ...
    public function habilitar() {
        ...
        header('Location: index.php?controller=insumo&action=listarTodo'); exit;
    }
