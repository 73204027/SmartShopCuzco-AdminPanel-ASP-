<?php
require_once '../models/tipo_direccion_model.php';
require_once '../config/export.php';
class tipodireccion_controller {
    private $modelo;
    public function __construct() {
        $this->modelo = new TipoDireccion();
    }
    public function listar() {
        ...
        require_once '../views/tipo_direccion/listar_tipo_direccion.php';
    }
    public function listarTodo() {
        ...
        $totalPages = ceil($total/$limit);
        require_once '../views/tipo_direccion/habilitar_tipo_direccion.php';
    }
    public function cargarRegistrar() {
        require_once '../views/tipo_direccion/registrar_tipo_direccion.php';
    }
    public function cargarActualizar() {
        if(isset($_GET['id'])) {
            $item = $this->modelo->buscarPorId($_GET['id']);
            require_once '../views/tipo_direccion/actualizar_tipo_direccion.php';
        } else {
            header('Location: index.php?controller=tipodireccion&action=listar'); exit;
        }
    }
    ...
    public function habilitar() {
        ...
        header('Location: index.php?controller=tipodireccion&action=listarTodo'); exit;
    }
