...
require_once '../models/sexo_model.php';
require_once '../config/export.php';
class sexo_controller {
    private $modelo;
    ...
    public function listar() {
        ...
        require_once '../views/sexo/listar_sexo.php';
    }
    public function listarTodo() {
        ...
        $totalPages = ceil($total/$limit);
        require_once '../views/sexo/habilitar_sexo.php';
    }
    public function cargarRegistrar() {
        require_once '../views/sexo/registrar_sexo.php';
    }
    public function cargarActualizar() {
        if(isset($_GET['id'])) {
            $item = $this->modelo->buscarPorId($_GET['id']);
            require_once '../views/sexo/actualizar_sexo.php';
        } else {
            header('Location: index.php?controller=sexo&action=listar'); exit;
        }
    }
    ...
    public function habilitar() {
        ...
        header('Location: index.php?controller=sexo&action=listarTodo'); exit;
    }
