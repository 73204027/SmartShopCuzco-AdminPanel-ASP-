<?php
require_once '../models/categoriaproducto_model.php';
require_once '../config/export.php';
class categoriaproducto_controller {
    private $modelo;
    public function __construct() {
        $this->modelo = new CategoriaProducto();
    }
    public function listar() {
        ...
        require_once '../views/categoriaproducto/listar_categoriaproducto.php';
    }
    public function listarTodo() {
        ...
        $totalPages = ceil($total/$limit);
        require_once '../views/categoriaproducto/habilitar_categoriaproducto.php';
    }
    public function cargarRegistrar() {
        require_once '../views/categoriaproducto/registrar_categoriaproducto.php';
    }
    public function cargarActualizar() {
        if(isset($_GET['id'])) {
            $item = $this->modelo->buscarPorId($_GET['id']);
            require_once '../views/categoriaproducto/actualizar_categoriaproducto.php';
        } else {
            header('Location: index.php?controller=categoriaproducto&action=listar'); exit;
        }
    }
    ...
    public function habilitar() {
        ...
        header('Location: index.php?controller=categoriaproducto&action=listarTodo'); exit;
    }
