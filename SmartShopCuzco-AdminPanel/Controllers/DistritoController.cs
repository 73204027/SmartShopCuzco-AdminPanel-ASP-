...
class distrito_controller {
    private $modelo;
    public function __construct() {
        $this->modelo = new Distrito();
    }
    public function listar() {
        ...
        require_once '../views/distrito/listar_distrito.php';
    }
    public function listarTodo() {
        ...
        $totalPages = ceil($total/$limit);
        require_once '../views/distrito/habilitar_distrito.php';
    }
    public function cargarRegistrar() {
        require_once '../views/distrito/registrar_distrito.php';
    }
    public function cargarActualizar() {
        if(isset($_GET['id'])) {
            $item = $this->modelo->buscarPorId($_GET['id']);
            require_once '../views/distrito/actualizar_distrito.php';
        } else {
            header('Location: index.php?controller=distrito&action=listar'); exit;
        }
    }
    ...
    public function habilitar() {
        ...
        header('Location: index.php?controller=distrito&action=listarTodo'); exit;
    }
